            ...
            for i in range(1, len(h), 2):
                ...
                if T == 0:
                    if i+1 == len(h):
                        ...
                        h_[i][even][torch.arange(logits.size(0)), indices] = self.nMult/self.nMult
                    else:
            ...
            for i in range(0, len(h), 2):
                ...
                if T == 0:
                    if i+1 == len(h):
                        ...
                        h_[i][odd][torch.arange(logits.size(0)), indices] = self.nMult/self.nMult
                    else:
