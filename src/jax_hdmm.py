...
def tsne_visualization(data, file_prefix):
...
def umap_visualization(data, file_prefix):
    x_agg = data["x"].sum(axis=1)
    # === UMAP projection ===
...
def data_summary(model_return, data, struct_upbd, file_prefix):
    ...
    tsne_visualization(model_data, file_prefix)
    umap_visualization(model_data, file_prefix)
