...
class BernoulliRBM(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X):
        ...
        X = check_array(X, accept_sparse="csr", dtype=(np.float64, np.float32), ensure_2d=True, force_all_finite='allow-nan')
    ...
    def partial_fit(self, X, y=None):
        ...
        X = check_array(X, accept_sparse="csr", dtype=np.float64, ensure_2d=True, force_all_finite='allow-nan')
    ...
    def score_samples(self, X):
        ...
        v = check_array(X, accept_sparse="csr", dtype=np.float64, ensure_2d=True)
