...
class BernoulliSoftmaxRBM(BernoulliRBM):
    ...
    def _mean_hiddens(self, v):
        ...
        activations = safe_sparse_dot(v, self.components_.T) + self.intercept_hidden_
    ...
    def _free_energy(self, v):
        ...
        quad_term = 0.5 * np.sum(diff, axis=1)

        hidden_act = safe_sparse_dot(v, self.components_.T) + self.intercept_hidden_
